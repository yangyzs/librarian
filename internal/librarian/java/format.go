...
const maxFilesPerFormatBatch = 500
...
func Format(ctx context.Context, libraries ...*config.Library) error {
	...
	// Batch file paths in chunks of maxFilesPerFormatBatch (500 files).
	// Passing 500 files per CLI invocation avoids exceeding OS command-line length limits (ARG_MAX)
